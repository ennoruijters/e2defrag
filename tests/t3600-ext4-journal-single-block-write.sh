...
if [ "$1" != "do_test" ]; then
	test_begin "t3600-ext4-journal-single-block-write" "$0"
	exit $?
fi

load_image ext4-journal
load_data d3600-test.c

infra_cmd "cc -ggdb -o test -I ../../ d3600-test.c ../../journal.c ../../journal_init.c ../../io.c ../../crc16.c ../../rbtree.c ../../metadata_read.c"
